...
const getRelatedVideoUrl = baseUrl_tvpai + "video/client/longvideo/relatelong";//获取关联影片
const getSegmentListUrl = baseUrl_tvpai + "video/client/longvideo/episodeslist";//获取剧集列表
const getRelatedActorsUrl = baseUrl_tvpai + "video/client/longvideo/videorelateactors"; //获取相关影人信息
const getRelatedVideoByActorUrl = baseUrl_tvpai + "video/client/longvideo/actorrelatevideos"; //获取影人相关影片
const getTopicUrl = baseUrl_tvpai + "video/client/topic/get"; //获取片单信息
const getFavoriteTopicUrl = baseUrl_tvpai + "video/client/topic/getcollect"; //获取收藏的片单
const setFavoriteTopicUrl = baseUrl_tvpai + "video/client/topic/collect"; //收藏/取消收藏片单
...
const getBannerDataUrl = baseUrl_wx + "spread/homePageBanners.coocaa";//获取Banner数据
...
const getRelatedArticlesUrl = baseUrl_wx + "articleMoviesAPI/linkArticles.coocaa";//获取影片关联文章
const searchArticlesUrl = baseUrl_wx + "articleMoviesAPI/searchArticles.coocaa";//搜索文章
const submitFavoriteArticleUrl = baseUrl_wx + "articleMoviesAPI/appletEmpCollectArticle.coocaa"; //文章的收藏/取消收藏
const getFavoriteArticlesUrl = baseUrl_wx + "appletUsers/getCollectArticle.coocaa";//获取收藏文章
const getFavoriteVideosUrl = baseUrl_wx + "appletUsers/getCollectMovies.coocaa";//获取收藏影片
const getCommentsUrl = baseUrl_wx + "articleMoviesAPI/getCommentList.coocaa";//获取影片/文章评论
const submitCommentUrl = baseUrl_wx + "articleMoviesAPI/saveCommentByUser.coocaa";//提交影片/文章评论
const submitClickLikeUrl = baseUrl_wx + "articleMoviesAPI/clickLike.coocaa";//提交某条评论的点赞/取消点赞
const addMovieFavoriteUrl = baseUrl_wx + "articleMoviesAPI/appletCollectVideo.coocaa";//添加影片收藏
const getFavoriteStatusUrl = baseUrl_wx + "moviesAPI/getCollectStatus.coocaa";//根据movieid获取收藏状态
const delMovieFavoriteUrl = baseUrl_wx + "articleMoviesAPI/appletCancelCollectVideo.coocaa";//删除影片收藏
